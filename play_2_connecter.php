...
<html lang="en">
  ...
  <body>
    ...
    <section class="menu">
      ...
      <div class="score">
        <p>Player <br /><span id="score_o">0</span></p>
        <p>
          Egalité<br />
          <span id="nul">0</span>
        </p>
        <p>Computer<br /><span id="score_x">0</span></p>
      </div>
      <div class="icon">
        <a href="play_connecter.php"
          ><img src="asset/IMG/deux-personnes.png" alt="deux utilisateur"
        /></a>
      </div>
    </section>

    <script src="asset/JS/Play_2.js"></script>
  </body>
</html>
